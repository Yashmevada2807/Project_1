                ...
                <div className="form  w-[350px] max-w-[400px] ">
                    <form action="submit" className='flex flex-col '>
                        ...
                        <div className="button flex justify-center items-center  pt-8 ">
                            <button className='flex text-center justify-center rounded-md items-center py-2 w-full text-gray-300 bg-[#460967]'>LogIn</button>
                        </div>
                        <div className="footer pt-2 flex justify-center items-center">
                            <p className='text-gray-400 text-[12px]'>Don't have an account? <span className='text-[#820bc3] underline'>SignIn</span></p>
                        </div>
                    </form>
                </div>
            </div>
