...
const LoginPage = () => {
    ...
    const validate = values => {
        ...
        if (!values.username) {
            ...
            if (!userExists) {
                ...
                // Password check only if username exists
                if (!values.password) {
                    errors.password = 'Please Enter Password'
                } else {
                    const isPasswordCorrect = bcrypt.compareSync(values.password, userExists.password)
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            ...
            if (user) {
                const isPasswordCorrect = bcrypt.compareSync(values.password, user.password)
