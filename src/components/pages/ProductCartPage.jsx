  ...
  return (
    <div className="w-full min-h-screen bg-[#240634] px-4 md:px-10 py-20 flex flex-col md:flex-row gap-6">
      ...
      <div className="w-full md:w-1/5 rounded-xl overflow-hidden shadow-lg bg-[#310848]">
        ...
        <div>
          <div className="w-full py-3 border-b px-6 border-purple-950 flex justify-between items-center">
            <h1 className="text-white text-sm md:text-base">Item</h1>
            <h1 className="text-white text-sm md:text-base">Qty</h1>
            <h1 className="text-white text-sm md:text-base">Price</h1>
          </div>
          ...
          <div>
            {userCart.length === 0 ? (
              ...
              userCart.map(product => {
                ...
                return (
                  <div key={product.id} className="w-full py-3 flex border-b border-purple-900 justify-between px-4">
                    <h1 className="text-white w-[40%] truncate text-sm md:text-base">{product.title}</h1>
                    <h1 className="text-white w-[20%] text-center">{product.quantity}</h1>
                    <h1 className="text-white w-[20%] text-right">${finalPrice}</h1>
                  </div>
                )
              })
            )}
          ...
          <div className="mt-4 px-4 flex flex-col gap-2">
            <h1 className="text-white text-lg md:text-xl flex justify-between">
          ...
          <div className="flex justify-center mt-6 px-4">
            <button className="w-full md:w-auto text-center text-lg md:text-xl px-6 py-2 rounded text-white bg-purple-700 hover:bg-purple-800 transition">
              Buy Now
            </button>
          </div>
        </div>
